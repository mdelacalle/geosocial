...
/**
 * 
 * A vertical layout manager similar to java.awt.FlowLayout. Like FlowLayout components do not expand to fill available space
 * except when the horizontal alignment is <code>BOTH</code> in which case components are stretched horizontally. Unlike
 * FlowLayout, components will not wrap to form another column if there isn't enough space vertically. VerticalLayout can
 * optionally anchor components to the top or bottom of the display area or center them between the top and bottom.
 * 
 * Revision date 12th July 2001
 * 
 * @author Colin Mummery e-mail: colin_mummery@yahoo.com Homepage:www.kagi.com/equitysoft - Based on 'FlexLayout' in Java class
...
public class VerticalLayout
   ...
   //Constructors
   /**
    * Constructs an instance of VerticalLayout with a vertical vgap of 5 pixels, horizontal centering and anchored to the top of
    * the display area.
    */
   public VerticalLayout() {
      this(5, VerticalLayout.CENTER, VerticalLayout.TOP);
   }
    ...
    */
   public VerticalLayout(final int vgap1) {
      this(vgap1, VerticalLayout.CENTER, VerticalLayout.TOP);
   }
    ...
    */
   public VerticalLayout(final int vgap1,
                         final int alignment1) {
      this(vgap1, alignment1, VerticalLayout.TOP);
   }
   ...
   //----------------------------------------------------------------------------
   private Dimension layoutSize(final Container parent,
   ...
   public void layoutContainer(final Container parent) {
      ...
      synchronized (parent.getTreeLock()) {
         ...
         if (anchor == VerticalLayout.TOP) {
            y = insets.top;
         }
         else if (anchor == VerticalLayout.CENTER) {
            y = (pd.height - y) / 2;
         }
         else {
         ...
         for (int i = 0; i < n; i++) {
            ...
            int x = insets.left;
            int wid = d.width;
            if (alignment == VerticalLayout.CENTER) {
               x = (pd.width - d.width) / 2;
            }
            else if (alignment == VerticalLayout.RIGHT) {
               x = pd.width - d.width - insets.right;
            }
            else if (alignment == VerticalLayout.BOTH) {
